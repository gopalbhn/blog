...
const USER_DATA = [
    ...
    {
        id: "65f3a2b1c4e5f6a7b8c9d013",
        name: "Emma Davis",
        email: "emma@example.com",
        phone: "9851234567" // Ntc corporate range
    },
    {
        id: "65f3a2b1c4e5f6a7b8c9d014",
        name: "Ryan Walker",
        email: "ryan@example.com",
        phone: "9811234567" // Ncell range
    }
];
...
const seedUsers = async () => {
    try {
        ...
        const formattedUsers = USER_DATA.map(user => ({
            ...
            isVerified: true,
            role: "Author", // Validated against your enum ["Reader", "Writer"]
