        ...
        <div className='w-full h-full  px-10'>
            ...
            <div className='mt-10 mb-10'>
                ...
                {blog.commentsEnabled ? (
                    <div className="h-50 overflow-y-scroll no-scrollbar w-full px-10 " >
                        {blog.comments.map(comment => (
                            <div className="shadow-sm p-4   w-[80%] mt-5 rounded-lg flex gap-5 ">
                                <div className="h-10 w-10 rounded-full bg-primary flex items-center justify-center text-background-light">
                                    <User />
                                </div>
