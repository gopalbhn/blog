...
import { ChevronRight, LucideListFilter, } from 'lucide-react'
          ...
          <div>
            <section className='h-full w-full mt-10 '>
              ...
              <div className=' grid grid-cols-4 gap-5 mt-10'>
                ...
                {post.filter(blog => blog.category === "Science").map(blog => (
            ...
            <section className='h-full w-full mt-10 '>
              ...
              <div className='h-full w-full grid grid-cols-4 mt-10 '>
                ...
                {post.filter(blog => blog.category === "Travel").map(blog => (
                  <BlogCard key={blog.title} title={blog.title} image={blog.image} category={blog.category} author={blog.author} excerpt={blog.description} publishedAt={blog.createdAt} id={blog._id} />
            ...
            <section className='h-full w-full mt-10 '>
              ...
              <div className='h-full w-full grid grid-cols-4 mt-10 '>
                ...
                {post.filter(blog => blog.category === "Technology").slice(0, 4).map(blog => (
                  <BlogCard key={blog.title} title={blog.title} image={blog.image} category={blog.category} author={blog.author} excerpt={blog.description} publishedAt={blog.createdAt} id={blog._id} />
            ...
            <section className='h-full w-full mt-10 '>
              ...
              <div className='h-full w-full grid grid-cols-4 mt-10 '>
                ...
                {post.filter(blog => blog.category === "Business").map(blog => (
                  <BlogCard key={blog.title} title={blog.title} image={blog.image} category={blog.category} author={blog.author} excerpt={blog.description} publishedAt={blog.createdAt} id={blog._id} />
            ...
            <section className='h-full w-full mt-10 '>
              ...
              <div className='h-full w-full grid grid-cols-4 mt-10 '>
                ...
                {post.filter(blog => blog.category === "Health").map(blog => (
                  <BlogCard key={blog.title} title={blog.title} image={blog.image} category={blog.category} author={blog.author} excerpt={blog.description} publishedAt={blog.createdAt} id={blog._id} />
